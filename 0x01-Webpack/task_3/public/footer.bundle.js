...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(() => {
    ...
    const copyrigth = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<p>').text('Copyright - Holberton School');
